...
// @namespace    none
// @version      0.1.0.38
// @description  .win enhancement suite - unstable version
// @author       melvin
...
// @downloadURL  https://github.com/ilovestaples/wes/raw/master/wes/WES-dev.user.js
// @updateURL    https://github.com/ilovestaples/wes/raw/master/wes/WES-dev.user.js
...
(function() {
    ...
    function isExpandable(link){
        return isImage(link.href) || isVideoFile(link.href) || isTweet(link.href) || isYoutubeLink(link.href) || isImgurAlbum(link.href) || isImgurGallery(link.href) || isStreamable(link.href) || isBitchute(link.href) || isBannedVideo(link.href) || isMAGAVideo(link.href);
    }
