...
(function() {
    ...
    function isExpandable(link){
        return isImage(link.href) || isVideoFile(link.href) || isTweet(link.href) || isYoutubeLink(link.href) || isImgurAlbum(link.href) || isImgurGallery(link.href) || isStreamable(link.href) || isBitchute(link.href);
    }
    ...
    function expandMedia(node){
        console.log("expandMedia triggered");
