...
(function() {
    ...
    function generalEnhancerAddNavigationBar() {
        ...
        const winsitesArray = ["thedonald", "consumeproduct", "conspiracies", "omegacanada", "kotakuinaction", "kotakuinaction2", "gavinmcinnes", "tuckercarlson", "weekendgunnit", "greatawakening", "ip2always", "communities"];
