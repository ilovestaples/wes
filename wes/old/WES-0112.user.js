...
(function() {
    ...
    function isExpandable(link){
        return isImage(link.href) || isVideoFile(link.href) || isTweet(link.href) || isYoutubeLink(link.href) || isImgurAlbum(link.href) || isImgurGallery(link.href) || isStreamable(link.href);
    }
    ...
    function createExpandoButton(url){
        ...
        checkbox.addEventListener( 'change', function() {
            if(this.checked) {
                this.parentElement.querySelector("path").style.fill = "#ffe66d";
