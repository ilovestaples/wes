...
// @namespace    none
// @version      0.1
// @description  thedonald.win enhancement suite!
// @author       melvin
...
(function() {
    'use strict';
        ...
        document.getElementsByClassName('style-tag')[0].innerHTML = css;
        ...
        var wh = document.getElementsByClassName("wrapper home")[0];
        wh.insertBefore(top_bar, wh.children[1]);
        document.getElementsByClassName("theme-switcher")[0].style.zIndex = 1;
        ...
        wh.insertBefore(tools_bar, wh.children[4]);
